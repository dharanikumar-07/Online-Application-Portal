...
<?php 
	...
	$dis="INSERT INTO `studentdetails`(`rollno`,`name`, `gender`, `bloodgroup`, `branchanddegree`, `fathername`, `mothername`, 
	`annualincome`, `mothertongue`, `religion`, `community`, `parentnumber`, `studentnumber`, `address`, `dateofbirth`, 
	`aadhar`) VALUES ('$rollno','$name','$gender','$bloodgroup','$branchanddegree','$fathername','$mothername','$annualincome','$mothertongue','$religion',
	'$Community','$ParentMobile','$studentMobile','$address','$dob','$aadhar')";
