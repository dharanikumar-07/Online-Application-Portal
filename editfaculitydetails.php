...
<body>
		...
		<h3 style="text-align:center;color:red;padding:2px;"><b><i>Edit Faculity Details List</i></b></h3>
		<div class="fo">
		...
		<select  name="qa" style="width:200px;">
 		...
 		<select  name="ds" style="width:200px;">
			...
			<option name="ds" value="Nothing" >Nothing</option>
		</select><br>
...
<?php 
	...
	$dis="UPDATE `faculitydetails` SET `name`='$name',
	`date of birth`='$dateofbirth',`gender`='$gender',`blood group`='$bloodgroup',
	`education`='$educationalqual',`branch`='$branch',`address`='$address',
	`mobile no`='$Mobileno',`login password`='$secondMobileno',
	`appointed as`='$qa',`year`='$year' WHERE `faculity id`='$faculityid'";
	...
	if($r)
	{
		...
		echo "<script>alert('please enter valid faculity details')</script>";
	}
}
?><br>
