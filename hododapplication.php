...
<body>
    ...
    <div class="d-flex align-items-start">
      <div id="bd">
		...
		<a href="tutormain.php"><button class="nav-link" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">Faculity Database&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button></a>
        ...
        <div class="tab-content" id="v-pills-tabContent">
		  ...
		  &nbsp;&nbsp;&nbsp;OD APPLICATION</i></b></h2><br>
	        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="hodinternalod.php"><button id="ub">Internal</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	        <a href="hodexternalod.php"><button id="bu">External</button></a><br><br>
				<!---->
		  <!--ended first box-->
		  </div>
