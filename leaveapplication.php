...
<body>
    ...
    <div class="d-flex align-items-start">
      <div id="bd">
		...
		<a href="leaveapplication.php"><button class="nav-link  active" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false" >Leave Application&nbsp;&nbsp;<i class="bi bi-bell-fill" id="noti_number"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		  ...
		  function loadDoc(){          
		   ...
		   loadDoc();
			...
			<a href="odapplication.php"><button class="nav-link" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">Od Application&nbsp;&nbsp;
        ...
        <div class="tab-content" id="v-pills-tabContent">
		  ...
		  <h2 style="color:black;"><b><i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LEAVE APPLICATION</i></b></h2><br>
	        <a href="tutormedical.php"><button id="ub">Medical</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	        <a href="casualtutor.php"><button id="bu">Casual</button></a><br><br>
				<!---->
		  <!--ended first box-->
		  </div>
